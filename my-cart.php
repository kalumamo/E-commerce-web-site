...
?>
					...
					<td class="cart-product-sub-total"><span class="cart-sub-total-price"><?php echo "Birr"." ".$row['productPrice']; ?>.00</span></td>
<td class="cart-product-sub-total"><span class="cart-sub-total-price"><?php echo "Birr"." ".$row['shippingCharge']; ?>.00</span></td>
