					...
					<div class="products">
						...
						<div class="product-info text-left m-t-20">
							...
							<div class="product-price">	
								<span class="price">
							Birr. <?php echo htmlentities($rws['productPrice']);?>.00
								</span>
...
<div class="stock-container info-container m-t-10">
							...
							<div class="price-container info-container m-t-20">
								<div class="row">
									...
									<div class="col-sm-6">
										<div class="price-box">
											<span class="price">Birr. <?php echo htmlentities($row['productPrice']);?></span>
											<span class="price-strike">Birr.<?php echo htmlentities($row['productPriceBeforeDiscount']);?></span>
										</div>
									</div>
...
while($rw=mysqli_fetch_array($qry))
{
	...
	<div class="product">		
		...
		<div class="product-info text-left">
			...
			<div class="product-price">	
				<span class="price">
					Birr.<?php echo htmlentities($rw['productPrice']);?>			</span>
										     <span class="price-before-discount">Birr.
